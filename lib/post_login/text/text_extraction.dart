...
//       body: const Center(
//         child: Text("Profile Building Page"),
//       ),
//     );
//   }
// }
...
class _TextExtractionPageState extends State<TextExtractionPage> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          // Profile section on TextExtractionPage
          Positioned(
            top: 80,
            right: 24,
            child: GestureDetector(
            ...
            child: Row(
              ...
              Column(
                ...
                IconButton(
                  ...
                  tooltip: 'Download',
                  onPressed: () {
                  Navigator.pushNamed(context, '/business_card_downloads');
                  ScaffoldMessenger.of(context).showSnackBar(
              ...
              Column(
                ...
                IconButton(
                  ...
                  tooltip: 'Dataset',
                  onPressed: () {
                  Navigator.pushNamed(context, '/business_card_datasets');
                  ScaffoldMessenger.of(context).showSnackBar(
          ...
          // HOME TEXT
            ...
            child: Column(
              ...
              Padding(
                ...
                child: Text(
                'Can extract fields like - Name, Designation, \nEmail, Phone Number, etc...',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
              ...
              _buildActionButton(
                ...
                label: '   BUSINESS CARD   ',
                onPressed: () {
                Navigator.pushNamed(context, '/business_card_initial');
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Navigate to Business Card Processing')),
                );
                },
              ),
          ...
          Positioned(
            ...
            child: Column(
              ...
              Padding(
                padding: EdgeInsets.only(left: 20.0, bottom: 25.0),
                child: Text(
                'Can extract fields like - Invoice, Amounts, \nAddress, GST Number, etc...',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
              ...
              onPressed: () {
                Navigator.pushNamed(context, '/pdf_initial');
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Navigate to PDF Processing')),
                );
              },
            ),
              ],
  ...
  Widget _buildActionButton({
    ...
    final isPdf = label == 'PORTABLE DOCUMENT \nFORMAT';
    return SizedBox(
      width: 330,
      height: 110,
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Icon(
                  icon,
                  color: label == '   BUSINESS CARD   ' ? Colors.yellow : Colors.white,
                  size: 50,
                ),
              ),
            ),
